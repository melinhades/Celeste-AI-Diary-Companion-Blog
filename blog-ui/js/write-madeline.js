(function () {
    ...
    function buildPanel() {
        ...
        style.textContent =
            ...
            '.polish-run-anim{width:64px;height:64px;background-size:contain;background-repeat:no-repeat;background-position:center;animation:polishRun .81s infinite;filter:drop-shadow(0 2px 8px rgba(0,0,0,.5));}' +
            '@keyframes polishRun{0%{background-image:url("celeste-gui/loading/loading-0.png")}11.1%{background-image:url("celeste-gui/loading/loading-1.png")}22.2%{background-image:url("celeste-gui/loading/loading-2.png")}33.3%{background-image:url("celeste-gui/loading/loading-3.png")}44.4%{background-image:url("celeste-gui/loading/loading-4.png")}55.5%{background-image:url("celeste-gui/loading/loading-5.png")}66.6%{background-image:url("celeste-gui/loading/loading-6.png")}77.7%{background-image:url("celeste-gui/loading/loading-7.png")}88.8%{background-image:url("celeste-gui/loading/loading-8.png")}}' +
